    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'indexes': [django.contrib.postgres.indexes.GinIndex(fields=['private_metadata'], name='pagetype_p_meta_idx'), django.contrib.postgres.indexes.GinIndex(fields=['metadata'], name='pagetype_meta_idx'), django.contrib.postgres.indexes.GinIndex(fields=['name', 'slug'], name='page_type_name_slug_gin', opclasses=['gin_trgm_ops', 'gin_trgm_ops'])],
            },
        ),
        migrations.CreateModel(
            name='Page',
        ...
        migrations.AddIndex(
            model_name='page',
            index=django.contrib.postgres.indexes.GinIndex(fields=['title', 'slug'], name='page_title_slug_gin', opclasses=['gin_trgm_ops', 'gin_trgm_ops']),
        ),
    ]
