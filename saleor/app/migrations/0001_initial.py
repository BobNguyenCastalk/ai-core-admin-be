    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField()),
                ('mount', models.CharField(choices=[('customer_overview_create', 'customer_overview_create'), ('customer_overview_more_actions', 'customer_overview_more_actions'), ('customer_details_more_actions', 'customer_details_more_actions'), ('navigation_customers', 'navigation_customers'), ('navigation_translations', 'navigation_translations'), ('navigation_pages', 'navigation_pages')], max_length=256)),
